...
def enable_logging(
    ...
    logger.enable("snakeframe")


if literal_eval(os.environ.get("SNAKEFRAME_LOG", "False")):
    level = int(os.environ.get("SNAKEFRAME_LOG_LEVEL", 20))
    stdout = literal_eval(os.environ.get("SNAKEFRAME_STDOUT", "True"))
    file_path = os.environ.get("SNAKEFRAME_LOG_FILE_PATH", None)
